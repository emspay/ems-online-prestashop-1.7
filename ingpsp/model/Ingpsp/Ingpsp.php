...
/**
 * Keep ingpsp internal order data
 *
 * @author bojan
 */
class Ingpsp {
    ...
    const PAYMENT_METHOD_KLARNA = 'ingpspklarna';
    const PAYMENT_METHOD_AFTERPAY = 'ingpspafterpay';
    ...
    {
        return $this->payment_method === self::PAYMENT_METHOD_AFTERPAY; 
    }
    
    public function setAfterPayPaymentMethod()
    {
        $this->payment_method = static::PAYMENT_METHOD_AFTERPAY;
    }
