...
class ingpsp extends PaymentModule
{
    ...
    protected function initiateAllowedProducts()
    {
        if (Configuration::get('ING_PSP_APIKEY') && Configuration::get('ING_PSP_PRODUCT')) {
            $this->ginger = GingerClientFactory::create(new GingerClientFactoryParams('ginger', Configuration::get('ING_PSP_APIKEY'), Configuration::get('ING_PSP_PRODUCT'), Configuration::get('ING_PSP_BUNDLE_CA')));
