...
class emspayTikkiePaymentRequest extends EmsPayPaymentModule
{
    ...
    public function install()
    {
        ...
        if (!$moduleManager->isInstalled('emspay')) {
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $paymentOption->setCallToActionText($this->l('Pay by Tikkie Payment Request'));
