...
$_MODULE['<{emspayafterpay}prestashop>emspayafterpay_7c3b0b7e5a45e86906205db0b6b1ed75'] = 'Helaas kunt u AfterPay niet gebruiken omdat AfterPay alleen beschikbaar is voor adressen in Nederland en België. Gebruik alstublieft het juiste adres of selecteer een andere betaalmethode.';
...
$_MODULE['<{emspayafterpay}prestashop>payment_9e0f0cf5c70444031ed87782ba3422b2'] = 'Ik accepteer AfterPay';
$_MODULE['<{emspayafterpay}prestashop>payment_1d8cd2bfc6943dcf70236f7d351572a0'] = 'Gebruiksvoorwaarden';
$_MODULE['<{emspayafterpay}prestashop>payment_6a1c0ea4d3b789b3025a73cd977b4a7a'] = 'AUB de algemene voorwaarden accepteren';
$_MODULE['<{emspayafterpay}prestashop>payment_return_68a489dbc8079a40832c3d558fcfb069'] = 'Uw bestelling bij %s';
$_MODULE['<{emspayafterpay}prestashop>payment_return_0f9b4be6207d496fc281b0cce2eeed3b'] = 'Dank voor uw bestelling. Uw betaling is succesvol verwerkt.';
